...
export const SignUpSchema = z.object({
  ...
  birthDate: z.string().min(10, { message: 'La fecha debe tener 10 caracteres' }), // date({invalid_type_error:"Debes proveer una fecha valida"}),
  gender: z.enum(['MALE', 'FEMALE', 'NOT_BINARY'], { invalid_type_error: 'El genero es requerido y debe ser: MALE, FEMALE, NOT_BINARY' })
})
